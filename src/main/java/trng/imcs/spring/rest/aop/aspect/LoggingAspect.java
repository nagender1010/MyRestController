package trng.imcs.spring.rest.aop.aspect;
...
public class LoggingAspect {
	...
	@AfterReturning(pointcut = "execution(* trng.imcs.spring.rest.serviceImpl..*(..))", returning = "result")
	public void logAfterReturning(JoinPoint joinPoint, Object result) {
		...
		logger.info("hijacked class : " + className);
	...
	@AfterThrowing(pointcut = "execution(* trng.imcs.spring.rest.serviceImpl..*(..))", throwing = "error")
	...
	@Around("execution(* trng.imcs.spring.rest.serviceImpl..*(..))")
	public Object logMethod(final ProceedingJoinPoint joinPoint) throws Throwable {
		...
		logger.info("****************************Entered Around Method******************************");
		try {
